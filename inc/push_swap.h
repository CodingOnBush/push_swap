...
/*   Updated: 2023/12/29 14:10:58 by momrane          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_a_nodes(t_stack_node *a, t_stack_node *b);             
		// To prep all nodes for pushing `a` to `b`
void	ft_init_b_nodes(t_stack_node *a, t_stack_node *b);             
		// To prep all nodes for pushing `b` back to `a`
void	ft_update_indexes(t_stack_node *stack);                        
		// Set the node's current index
void	ft_push_node_on_top(t_stack_node **s, t_stack_node *n, char c);
