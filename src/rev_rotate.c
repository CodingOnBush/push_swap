...
void	rra(t_node **a, int print) //Rotate the bottom of `a` to the top of the stack and print the instruction
{
	rev_rotate(a);
	if (!print)
		ft_putstr_fd("rra\n", 1);
...
void	rrb(t_node **b, int print) //Rotate the bottom of `b` to the top of the stack and print the instruction
{
	rev_rotate(b);
	if (!print)
		ft_putstr_fd("rrb\n", 1);
...
void	rrr(t_node **a, t_node **b, int print) //Stimultaneously rotate both stacks' bottom nodes to the top of their stacks, halving the cost of instructions
{
	rev_rotate(a);
	rev_rotate(b);
	if (!print)
